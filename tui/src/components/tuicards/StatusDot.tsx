...
export function StatusDot({ status }: { status: TuiStatus | string }) {
...
// Derive a status from a generic ToolLog. The wire shape doesn't carry an
...
export function toolLogStatus(log: ToolLog): TuiStatus {
